...
#        'end_snapshot': '/big/software/visionworkbench/bin/snapshot',
        'mosaic': '/big/local/visionworkbench/bin/image2plate',
        'image2plate': '/big/local/visionworkbench/bin/image2plate',
        'mipmap': '/big/local/visionworkbench/bin/mipmap',
        'snapshot': '/big/local/visionworkbench/bin/snapshot',
        'start_snapshot': '/big/local/visionworkbench/bin/snapshot',
        'end_snapshot': '/big/local/visionworkbench/bin/snapshot',
